...
export default function VacancyDetailsPage() {
  const { id } = useParams();
  const { isAuthenticated, loginWithRedirect, getAccessTokenSilently, isLoading: isAuthLoading } = useAuth0();
    ...
    const fetchJobDetails = async () => {
      ...
      try {
        ...
        setJob({
            ...
            salary: `$${data.salary}`,
            type: data.type,
            postedAt: new Date(data.createdAt).toLocaleDateString("en-US", { day: 'numeric', month: 'long' }),
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <Link to="/jobs" className="flex items-center text-sm font-medium text-slate-500 hover:text-indigo-600">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {job.skills.map((skill) => (
                  <Badge key={skill} variant="secondary" className="bg-slate-200 text-slate-700 hover:bg-slate-300">
                    {skill}
                  </Badge>
                ))}
              </div>
            ...
            {job.matchScore && (
              <div className="rounded-xl border border-indigo-100 bg-gradient-to-r from-indigo-50/50 to-white p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <h2 className="text-lg font-semibold text-slate-900">Your Compatibility Profile</h2>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    <div className="relative h-32 w-32 flex-shrink-0">
                        <svg className="h-full w-full -rotate-90" viewBox="0 0 36 36">
                            ...
                            <path className="text-indigo-600" strokeDasharray={`${job.matchScore}, 100`} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="3" />
                        </svg>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-2xl font-bold text-indigo-700">{job.matchScore}%</span>
            ...
            <div className="prose prose-slate max-w-none text-slate-700">
                ...
                <ul className="list-disc pl-5 mb-6 space-y-1">
                    ...
                    <li>Ensure high performance and responsiveness of applications.</li>
                </ul>
                ...
                <ul className="list-disc pl-5 mb-6 space-y-1">
                    ...
                    <li>Strong understanding of modern CSS and UI/UX principles.</li>
                    <li>Experience with server-side rendering (Next.js) is a plus.</li>
                </ul>
            </div>
          </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <Link to="#" className="text-xs text-indigo-600 hover:underline">View company profile</Link>
                        </div>
                    </div>
                    <p className="text-sm text-slate-500 mb-4">
                        A leading innovator in the fintech space, focused on revolutionizing global payments through blockchain technology.
                    </p>
                    <Button variant="ghost" className="w-full text-sm h-auto py-2 text-slate-600">
